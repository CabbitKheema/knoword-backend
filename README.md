...
<h3 align="center">knoword-backend</h3>

  <p align="center">
    Express.js backend APIs retrieving word meanings via text/voice for <a href="https://github.com/CabbitKheema/knoword"><strong>knoword</strong></a> PWA.
    <br />
    <a href="https://www.postman.com/science-physicist-1938228/knoword/documentation/08isa39/knoword-backend-tests"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://ck-knoword.netlify.app/">View Demo</a>
    &middot;
    <a href="https://github.com/CabbitKheema/knoword-backend/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    &middot;
    <a href="https://github.com/CabbitKheema/knoword-backend/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
* By integrating into the [knoword][knoword-url] PWA, users can stay engaged with their reading while resolving their doubts instantly.
...
1. Clone the repo
   ```sh
   git clone https://github.com/CabbitKheema/knoword-backend.git
   ```
...
4. Save this in root directory in a file titled `.env` and **follow the commented instructions** prefixed with ```//``` below
   ...
   POSTMAN_COLLECTION_FILE_PATH=./collections/knoWord_Backend_Tests.postman_collection.json
   POSTMAN_GLOBALS_FILE_PATH=./globals/workspace.postman_globals.json
   POSTMAN_ENVIRONMENT_FILE_PATH=./local_environment/knoWord_backend_local.postman_environment.json
   ```
...
[knoWord Backend Tests Collection][knoword-backend-tests-collection-url] contains test cases for the [knoword-backend][knoword-backend-url], a service powering the [knoword][knoword-url] PWA.

Click this to fork the collection to you local postman workspace,

[![Run In Postman](https://run.pstmn.io/button.svg)][fork-knoword-backend-tests-collection-url] 

_For better understanding, please refer to the [knoWord Backend Tests Documentation][knoword-backend-tests-documentation-url]_
...
See the [open issues](https://github.com/CabbitKheema/knoword-backend/issues) for a full list of proposed features (and known issues).
...
<a href="https://github.com/CabbitKheema/knoword-backend/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=CabbitKheema/knoword-backend" alt="contrib.rocks image" />
</a>
...
Project Link: [https://github.com/CabbitKheema/knoword-backend](https://github.com/CabbitKheema/knoword-backend)
...
<!-- https://www.markdownguide.org/basic-syntax/#reference-style-links -->
[knoword-backend-tests-collection-url]: https://www.postman.com/science-physicist-1938228/workspace/knoword/collection/41172600-bc0af1e9-b249-4415-af88-5dfbc6efb759?action=share&creator=41172600&active-environment=41172600-d7a3beb2-5d06-448b-b351-9d68620b0e50
[fork-knoword-backend-tests-collection-url]: https://app.getpostman.com/run-collection/41172600-bc0af1e9-b249-4415-af88-5dfbc6efb759?action=collection%2Ffork&source=rip_markdown&collection-url=entityId%3D41172600-bc0af1e9-b249-4415-af88-5dfbc6efb759%26entityType%3Dcollection%26workspaceId%3D83711707-5270-464c-8e5e-00a5e3fd2209#?env%5BknoWord_backend_local%5D=W3sia2V5IjoiQkFDS0VORF9VUkwiLCJ2YWx1ZSI6Imh0dHA6Ly9sb2NhbGhvc3Q6MzAwMCIsImVuYWJsZWQiOnRydWUsInR5cGUiOiJkZWZhdWx0Iiwic2Vzc2lvblZhbHVlIjoiaHR0cDovL2xvY2FsaG9zdDozMDAwIiwiY29tcGxldGVTZXNzaW9uVmFsdWUiOiJodHRwOi8vbG9jYWxob3N0OjMwMDAiLCJzZXNzaW9uSW5kZXgiOjB9XQ==
[knoword-backend-tests-documentation-url]: https://www.postman.com/science-physicist-1938228/knoword/documentation/08isa39/knoword-backend-tests
[knoword-url]: https://github.com/CabbitKheema/knoword
[knoword-backend-url]: https://github.com/CabbitKheema/knoword-backend
[contributors-shield]: https://img.shields.io/github/contributors/CabbitKheema/knoword-backend.svg?style=for-the-badge
[contributors-url]: https://github.com/CabbitKheema/knoword-backend/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/CabbitKheema/knoword-backend.svg?style=for-the-badge
[forks-url]: https://github.com/CabbitKheema/knoword-backend/network/members
[stars-shield]: https://img.shields.io/github/stars/CabbitKheema/knoword-backend.svg?style=for-the-badge
[stars-url]: https://github.com/CabbitKheema/knoword-backend/stargazers
[issues-shield]: https://img.shields.io/github/issues/CabbitKheema/knoword-backend.svg?style=for-the-badge
[issues-url]: https://github.com/CabbitKheema/knoword-backend/issues
[license-shield]: https://img.shields.io/github/license/CabbitKheema/knoword-backend.svg?style=for-the-badge
